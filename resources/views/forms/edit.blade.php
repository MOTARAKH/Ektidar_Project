<x-app-layout>
    <div class="container mx-auto p-6 bg-white shadow-md rounded-lg mt-2 rtl">
        <h1 class="text-2xl font-bold mb-4 text-right">تعديل النموذج</h1>
        ...
        <form action="{{ route('forms.update', $form->id) }}" method="POST">
            ...
            <!-- Title input -->
            <div class="mb-4">
                <label for="title" class="block text-sm font-medium text-gray-700 text-right">الجهة</label>
            ...
            <!-- Side input -->
            <div class="mb-4">
                <label for="side" class="block text-sm font-medium text-gray-700 text-right">الموضوع</label>
            ...
            <div id="descriptions-container" class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-2 text-right">التفاصيل</label>
                ...
                <button type="button" onclick="addDescriptionField()"
                    class="bg-blue-500 text-white p-2 rounded hover:bg-blue-600 mt-1">
            ...
            <!-- Finished checkbox -->
            <div class="mb-4">
                <label for="finished" class="block text-sm font-medium text-gray-700 text-right">تحديد النموذج كمكتمل</label>
...
input[type="text"]:focus {
    ...
    box-shadow: 0 0 0 1px #4f46e5; /* Focus shadow */
}
...
button.bg-red-500 {
    background-color: #ef4444; /* Background color for remove button */
}

button.bg-red-500:hover {
    background-color: #dc2626; /* Background color on hover */
}

button.bg-blue-500 {
    background-color: #3b82f6; /* Background color for add button */
}
...
button.bg-green-500 {
    background-color: #10b981; /* Background color for submit button */
}

button.bg-green-500:hover {
    background-color: #059669; /* Background color on hover */
}

button.bg-gray-500 {
    background-color: #6b7280; /* Background color for back button */
}

button.bg-gray-500:hover {
    background-color: #4b5563; /* Background color on hover */
}
