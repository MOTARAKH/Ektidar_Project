    ...
    <div class="container mx-auto p-6">
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <div class="mb-6">
                ...
                <div class="space-y-2">
                    <p><strong class="text-gray-600">ID:</strong> <span class="text-gray-800">{{ $form->id }}</span>
                    </p>
                    <p><strong class="text-gray-600">Title:</strong> <span
                            class="text-gray-800">{{ $form->title }}</span></p>
                    <p><strong class="text-gray-600">Side:</strong> <span
                            class="text-gray-800">{{ $form->side }}</span></p>
