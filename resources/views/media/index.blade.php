<x-app-layout>
    <div class="container mx-auto px-4 py-6">
        ...
        @else
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($media as $media)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap border-r border-gray-300">{{ $media->MediaOutlet }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap border-r border-gray-300">{{ $media->topic }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap border-r border-gray-300">{{ $media->ParticipatingParties }}
                                </td>
                        ...
                        <tr id="create-row" class="bg-gray-50 hidden">
                            <td colspan="4" class="px-6 py-4">
                                <form id="create-form" action="{{ route('media.storeFromMediaIndex') }}" method="POST">
                                    @csrf
            ...
            <!-- Pagination Links -->
        {{-- 3am y3ti error 3a bad call method shil command w  shuf shu ossa --}}
            {{-- <div class="mt-4">
