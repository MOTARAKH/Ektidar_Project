<x-app-layout>
    <div class="container mx-auto px-4 py-6">
        <h1 class="text-4xl font-bold mb-6">Forms</h1>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($receptions as $reception)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap border-r border-gray-300">{{ $reception->side }}
                                </td>
                        ...
                        <tr id="create-row" class="bg-gray-50 hidden">
                            <td colspan="4" class="px-6 py-4">
                                <form id="create-form" action="{{ route('receptions.storeFromIndex') }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        <label for="side"
                                            class="block text-sm font-medium text-gray-700">Side</label>
