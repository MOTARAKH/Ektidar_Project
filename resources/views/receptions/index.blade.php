<x-app-layout>
    <div class="container mx-auto px-4 py-6">
        <h1 class="text-4xl font-bold mb-6">استقبالات</h1>
        ...
        @if ($receptions->isEmpty())
            <div class="bg-yellow-100 text-yellow-800 p-4 rounded-lg shadow-md">
                لا توجد استقبالات. اضغط على زر "إنشاء استقبالات جديدة" للإضافة .
            </div>
        @else
            <div class="overflow-x-auto relative">
                <table class="min-w-full divide-y divide-gray-200 bg-white shadow-md rounded-lg border border-gray-300 rtl">
                    <thead class="bg-gray-100">
                        <tr>
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider border-l border-gray-300">
                                جهة
                            </th>
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider border-l border-gray-300">
                                وصف
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($receptions as $reception)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap border-l border-gray-300">{{ $reception->side }}</td>
                                ...
                                <td class="px-3 py-4 whitespace-nowrap">
                                    <div class="flex space-x-0 justify-end">
                                        ...
                                        @if (!$reception->finished == 1 || ($reception->finished == 1 && Auth::user()->isAdmin == 1))
                                    ...
                                    <div id="descriptions-container" class="mb-6">
                                        ...
                                        <div class="flex items-center mb-4" id="description-0">
                                            ...
                                            <button type="button" onclick="removeDescriptionField(0)"
                                                class="ml-3 bg-red-500 text-white p-2 rounded hover:bg-red-600 mt-1">
