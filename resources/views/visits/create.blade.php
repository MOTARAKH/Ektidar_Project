...
<x-app-layout>
    <div class="container mx-auto px-4 py-6">
        <h1 class="text-3xl font-semibold text-gray-800 mb-6 border-b border-gray-200 pb-2">انشاء زيارة</h1>

        <form action="{{ route('visits.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
            @csrf
