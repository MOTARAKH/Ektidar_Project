<x-app-layout>
    <div class="container mx-auto p-6">
        <div class="bg-white shadow-md rounded-lg p-6">
            <h1 class="text-3xl font-bold mb-4">Visits Details</h1>

            <div class="mb-6">
                <h2 class="text-xl font-semibold mb-2">Form Information</h2>
                <div class="space-y-2">
                    <p><strong class="text-gray-600">ID:</strong> <span class="text-gray-800">{{ $visit->id }}</span>
                    </p>
                    <p><strong class="text-gray-600">Side:</strong> <span
                            class="text-gray-800">{{ $visit->side }}</span></p>
